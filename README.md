...
This was a resource I needed for a legacy project that was only available on bower, not npm. 
I took the original repo, forked it, and updated some libraries. **It is not actively maintained otherwise** 
